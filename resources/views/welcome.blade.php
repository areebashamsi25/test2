...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="main-slider-three">
            <div class="slider-three_icon-one" data-parallax='{"y" : -80}'
                style="background-image:url(images/icons/service-22.png)"></div>
            <div class="slider-three_icon-two" data-parallax='{"y" : 80}'
                style="background-image:url(images/icons/service-23.png)"></div>
                ...
                <div class="slide">
                    ...
                    <div class="auto-container">
                        ...
                        <div class="slider-three_content-box">
                            <!-- About One Detail -->
                            <a class="slider-three_play lightbox-video fa-solid fa-play fa-fw"
            ...
            <div class="auto-container">
                <div class="row clearfix">
                    ...
                    <div class="service-block_five col-lg-3 col-md-6 col-sm-12">
                        <div class="service-block_five-inner wow fadeInLeft" data-wow-delay="0ms"
                            data-wow-duration="1500ms">
                            <div class="service-block_five-color-layer"></div>
                            <div class="service-block_five_pattern"
                                style="background-image:url(images/background/pattern-38.png)"></div>
                            <div class="service-block_five_icon"><img src="images/icons/service-18.png" alt="" /></div>
                            <h5 class="service-block_five_heading"><a href="service-detail.html">Best UI/UX Design
                                    Service</a></h5>
                            <div class="service-block_five-text">Our customer get solutions & business opportunities.
                            </div>
                    ...
                    <div class="service-block_five col-lg-3 col-md-6 col-sm-12">
                        <div class="service-block_five-inner wow fadeInLeft" data-wow-delay="0ms"
                            ...
                            <h5 class="service-block_five_heading"><a href="service-detail.html">Business Planner for
                                    Clients</a></h5>
                            <div class="service-block_five-text">Our customer get solutions & business opportunities.
                            </div>
                            <a href="service-detail.html" class="theme-btn service-block_five-more">Read more</a>
                    ...
                    <div class="service-block_five col-lg-3 col-md-6 col-sm-12">
                        <div class="service-block_five-inner wow fadeInLeft" data-wow-delay="0ms"
                            ...
                            <h5 class="service-block_five_heading"><a href="service-detail.html">Sequrity provider for
                                    Business</a></h5>
                            <div class="service-block_five-text">Our customer get solutions & business opportunities.
                            </div>
                            <a href="service-detail.html" class="theme-btn service-block_five-more">Read more</a>
                    ...
                    <div class="service-block_five col-lg-3 col-md-6 col-sm-12">
                        <div class="service-block_five-inner wow fadeInLeft" data-wow-delay="0ms"
                            ...
                            <h5 class="service-block_five_heading"><a href="service-detail.html">Technical Service
                                    Provider</a></h5>
                            <div class="service-block_five-text">Our customer get solutions & business opportunities.
                            </div>
                            <a href="service-detail.html" class="theme-btn service-block_five-more">Read more</a>
        ...
        <section class="company-three">
            <div class="company-three_icon-one" data-parallax='{"y" : -80}'
                style="background-image:url(images/background/pattern-39.png)"></div>
            <div class="company-three_icon-two" data-parallax='{"y" : 80}'
                style="background-image:url(images/background/pattern-40.png)"></div>
            <div class="auto-container">
                <div class="row clearfix">
                    <!-- Image Column -->
                    ...
                    <div class="company-three_content-column col-lg-6 col-md-12 col-sm-12">
                        <div class="company-three_inner">
                            ...
                            <h2 class="company-three_heading">Choose <span>The Best</span> IT Service Company in the
                                City.</h2>
                            <div class="d-flex justify-content-between align-items-center flex-wrap">
                                <div class="company-three_text">Want to join with our connection? <br> <a
                                        href="contact.html">Contact us</a> for details talk.</div>
                            ...
                            <!-- About One Detail -->
                            <a class="about-three_play lightbox-video"
                                href="https://www.youtube.com/watch?v=kxPCFljwJws">
        ...
        <section class="steps-two" style="background-image:url(images/background/6.jpg)">
            <div class="steps-two_pattern" data-parallax='{"y" : 60}'
                style="background-image:url(images/icons/service-23.png)"></div>
            <div class="steps-two_pattern-two" data-parallax='{"y" : 60}'
                style="background-image:url(images/icons/service-22.png)"></div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="step-block_two col-lg-3 col-md-6 col-sm-12">
                            <div class="step-block_two-inner">
                                <div class="step-block_two-number"><span
                                        class="icon fa-solid fa-check-double fa-fw"></span>01</div>
                                <h4 class="step-block_two-heading">Select Service</h4>
                                <div class="step-two_block-text">ITfirm is a design studio founded in London and
                                    expanded our multinational firm.</div>
                            </div>
                        </div>
                        ...
                        <div class="step-block_two col-lg-3 col-md-6 col-sm-12">
                            <div class="step-block_two-inner">
                                <div class="step-block_two-number"><span class="icon fa-solid fa-pencil fa-fw"></span>02
                                </div>
                        ...
                        <div class="step-block_two col-lg-3 col-md-6 col-sm-12">
                            <div class="step-block_two-inner">
                                <div class="step-block_two-number"><span class="icon fa-solid fa-cube fa-fw"></span>03
                                </div>
                        ...
                        <div class="step-block_two col-lg-3 col-md-6 col-sm-12">
                            <div class="step-block_two-inner">
                                <div class="step-block_two-number"><span class="icon fa-solid fa-link fa-fw"></span>04
                                </div>
        ...
        <section class="services-four">
            <div class="auto-container">
                ...
                <div class="sec-title_three centered">
                    ...
                    <h2 class="sec-title_three-heading">We provide some <span>exclusive</span> <br> services for clients
                    </h2>
                </div>
                <div class="inner-container">
                    <div class="row clearfix">
                        ...
                        <div class="service-block_six col-lg-4 col-md-6 col-sm-12">
                            <div class="service-block_six-inner">
                                <div class="service-block_six-content">
                                    ...
                                    <div class="service-block_six-text">Lorem ipsum dolor sit amet, con sectetur
        ...
        <section class="case-two">
            <div class="case-two_pattern" data-parallax='{"y" : 60}'
                style="background-image:url(images/icons/service-22.png)"></div>
            <div class="case-two_pattern-two" data-parallax='{"y" : 60}'
                style="background-image:url(images/icons/service-23.png)"></div>
            <div class="auto-container">
                <!-- Sec Title Three -->
                            ...
                            <div class="case-block_two-inner">
                                <div class="case-block_two-image">
                                    ...
                                    <div class="case-block_two-content">
                                        ...
                                        <h4 class="case-block_two-title"><a href="project-detail.html">ITFirm
                                                Webdesign</a></h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="contact-one_info col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact-one_info-outer">
                                        ...
                                        Our Mail Address
                                        <strong>help@gmail.com <br> example@gmail.com</strong>
                                    </div>
                                </div>
        ...
        <section class="testimonial-two">
            <div class="testimonial-two_pattern" data-parallax='{"y" : 60}'
                style="background-image:url(images/background/pattern-44.png)"></div>
            <div class="auto-container">
                <div class="row clearfix">

                    <!-- Image Column -->
                    <div class="testimonial-two_image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="testimonial-two_image-inner wow fadeInLeft" data-wow-delay="0ms"
                            data-wow-duration="1500ms">
                    ...
                    <div class="testimonial-two_carousel-column col-lg-6 col-md-12 col-sm-12">
                        <div class="testimonial-two_carousel-inner">
                            ...
                            <div class="sec-title_three">
                                ...
                                <h2 class="sec-title_three-heading">We have many good <br> <span>client’s</span> review
                                </h2>
                            </div>
                            <div class="single-item-carousel owl-carousel owl-theme">
                                ...
                                <div class="testimonial-block_two">
                                    <div class="testimonial-block_two-inner">
                                        <span class="testimonial-block_two-quote"><img src="images/icons/quote.png"
                                                alt="" /></span>
                                        <div class="testimonial-block_two-author">
                                            <img src="images/resource/author-10.jpg" alt="" />
                                        </div>
                                        <div class="testimonial-block_two-text">Lorem ipsum dolor sit amet, consectetur
                                            adipiscing elit, sed do eiusmod tempor incidi dunt ut labore et dolore magna
                                            aliqua.</div>
            ...
            <div class="auto-container">
                <div class="clients-three_inner-container">
                    ...
                    <ul class="sponsors-carousel-two owl-carousel owl-theme">
                        <li class="slide-item">
                            <figure class="client-one_image-box-two"><a href="#"><img src="images/clients/15.png"
                                        alt=""></a></figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box-two"><a href="#"><img src="images/clients/16.png"
                                        alt=""></a></figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box-two"><a href="#"><img src="images/clients/17.png"
                                        alt=""></a></figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box-two"><a href="#"><img src="images/clients/18.png"
                                        alt=""></a></figure>
                        </li>
                        <li class="slide-item">
                            <figure class="client-one_image-box-two"><a href="#"><img src="images/clients/15.png"
        ...
        <footer class="main-footer" style="background-image:url(images/background/pattern-11.png)">
            <div class="auto-container">
                ...
                <div class="footer-bottom">
                    <div class="copyright">2024 &copy; All rights reserved by <a href="#">She Leads Brands</a></div>
                </div>
